...
class UserRegistrationTest(TestCase):
    ...
    def test_edge_cases_handling(self):
        ...
        self.assertFormError(
            response, "form", "username", ["This field is required."], msg_prefix="form"
        )
        self.assertFormError(
            response, "form", "email", ["This field is required."], msg_prefix="form"
        )
        self.assertFormError(
            response,
            "form",
    ...
    def test_logout_verification(self):
        ...
        )  # Check if the user is redirected successfully
        self.assertTemplateUsed(
            response, "users/login.html"
        )  # Ensure that the login page template is used
...
class LoginTest(TestCase):
    ...
    def test_invalid_username(self):
        ...
        self.assertContains(
            response, "Please enter a correct username"
