...
# SECURITY WARNING: The secret key should not be kept in source code for
...
TEMPLATES = [
    {
        ...
        "APP_DIRS": True,  # Django will look for a “templates” subdirectory
...
# AUTH_PASSWORD_VALIDATORS configures validators that are used to check
# the strength of users’ passwords.
AUTH_PASSWORD_VALIDATORS = [
    # Validators for password strength, similarity to user attributes, commonness,
...
STATIC_URL = "static/"
STATICFILES_DIRS = [
    # Specifies additional directories where Django will look for static files
    BASE_DIR / "static",
]
...
# BigAutoField is a 64-bit integer, much like AutoField except it's guaranteed to
...
# Defines the URL where requests are redirected for login, especially when using
...
# Email Use TLS
# True enables the use of Transport Layer Security (TLS) to secure the connection with
# the mail server.
EMAIL_USE_TLS = True
# Email Host
# The host used for sending email. For example, 'smtp.gmail.com' for Gmail.
# 'sandbox.smtp.mailtrap.io' is used here for a mailtrap.io sandbox.
EMAIL_HOST = "sandbox.smtp.mailtrap.io"
# Email Host User
# Username to use for the SMTP server defined in EMAIL_HOST.
# Typically provided by your email service.
